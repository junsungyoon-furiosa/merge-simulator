...
export type WorkerRequest =
  | { version: 1; requestId: string; type: "runExperiment"; scenario: ScenarioConfig; policies: PolicyConfig[] }
  | { version: 1; requestId: string; type: "cancelExperiment" }
  | { version: 1; requestId: string; type: "replayRun"; scenario: ScenarioConfig; policy: PolicyConfig; repetition: number }
